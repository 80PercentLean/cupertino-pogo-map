...
Over time, the project evolved beyond being just a tool for Wayfinders. We expanded it to better support our broader Pokémon GO community by providing additional information such as parking, restrooms, and directions to specific points of interest. Today, supporting meetup attendees has become the project's primary purpose, while our smaller Wayfarer community continues to use it for Wayspot nominations and edits.

With the [release of the Wayfarer Map](https://community.wayfarer.nianticlabs.com/t/the-wayfarer-map-is-here/111209), we now pull all of the Wayspot data from there, ensuring 100% accuracy of information on our maps.
